...
class Console {
    ...
    //public static var printTime = true;
    ...
    public static inline function clear() Sys.print( '\033c' );
    //public static inline function clear() Sys.command( 'clear' );

    public static function prompt( untilCharCode = 13 ) : String {
        var str = '';
        while( true ) {
    ...
    public static inline function print( obj : Dynamic, ?color : Int ) {
        #if (!no_console&&!doc_gen)
        var str = Std.string( obj );
        /*
        if( printTime ) {
            var time = Std.string( om.Time.now() );
            var i = time.indexOf('.');
    ...
    public static inline function log( obj : Dynamic ) #if (!no_console&&!doc_gen) print( obj ) #end;
    public static inline function info( obj : Dynamic ) #if (!no_console&&!doc_gen) print( obj, color_info ) #end;
    public static inline function debug( obj : Dynamic ) #if (!no_console&&!doc_gen) print( obj, color_debug ) #end;
    public static inline function warn( obj : Dynamic ) #if (!no_console&&!doc_gen) print( obj, color_warn ) #end;
    public static inline function error( obj : Dynamic ) #if (!no_console&&!doc_gen) print( obj, color_error ) #end;
